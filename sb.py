...
#client = LineClient()
client = LineClient(authToken='EtqirWLBXJyMFb278zif.4YSrMg2oNLZ3c2qS97Qi+W.Li+KoSkmz/LWgjk7T3HP46LAG8MkAKtBctY5eB3uBV0=')
                ...
                if msg.text != None:
                    if msg.toType == 2:
                        ...
                        if may in str(msg.contentMetadata) and 'MENTION' in str(msg.contentMetadata):
                            pilih = ['yang tag sy semoga jomblo seumur hidup','ngapain tag tag woe, kangen?','แท็กทำไมหรอ คนับ มีทุระ ฝากข้อความทิ้งไว้ ว่างจะมาตอบ ขอบคุณครับ','duhh kena tag, dianya kesepian kali yah','gk usah tag, gift tikel aja']
                    ...
                    if msg.contentType == 0:
                        if msg.toType == 2:
                            ...
                            if text.lower() == 'me':
                                ...
                                client.sendText(receiver, "จำนวนสมาชิค :"+str(jml))
                    ...
                    if cctv['cyduk'][op.param1]==True:
                        if op.param1 in cctv['point']:
                            ...
                            if Name in cctv['sidermem'][op.param1]:
                                ...
                                pref=['eh ada','ชื่อห้อง','aloo..','nah','lg ngapain','เจ้าของห้อง','sini kak']
